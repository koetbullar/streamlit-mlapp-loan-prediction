...
file_url = "https://raw.githubusercontent.com/koetbullar/streamlit-mlapp-loan-prediction/master/RF_Loan_model.joblib"
...
def prediction(Gender, Married, Dependents,
    ...
    prediction = model.predict([[Gender, Married, Dependents, Education, Self_Employed, LoanAmount, Loan_Amount_Term,
